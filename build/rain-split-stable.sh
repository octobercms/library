...
./../git-subsplit.sh publish --heads="1.1" themes/demo:git@github.com:octoberrain/demo-theme.git
./../git-subsplit.sh publish --heads="1.1" plugins/october/demo:git@github.com:octoberrain/demo-plugin.git
popd
