...
class QueryBuilder extends QueryBuilderBase
{
     ...
     * This method is more memory-efficient than chunk() for very large datasets
     ...
     * This method is useful for processing large datasets in reverse order
     * (Laravel 12 performance optimization).
     *
     * @param  int  $chunkSize
     * @param  string|null  $column
     ...
     * This method ensures consistent ordering and handles deletions properly
     * (Laravel 12 performance optimization).
     *
    ...
    /**
     * Chunk the results of the query while keeping the query consistent.
     * This prevents issues when modifying records during iteration
     * (Laravel 12 performance optimization).
     *
     * @param  int  $count
     * @param  callable  $callback
